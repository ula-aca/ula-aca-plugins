...
interface AcceptInvitationMessage {
  type: ConnectionMessageTypes.ACCEPT_INVITATION
  body: AcceptInvitationBody
}

type AcceptInvitationResult = ConnectionRecord

export { AcceptInvitationMessage, AcceptInvitationBody, AcceptInvitationResult }
